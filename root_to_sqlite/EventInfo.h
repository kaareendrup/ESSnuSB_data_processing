...
#include <TObject.h>
#include <string.h> // Added by Kaare
...
class EventInfo : public TObject
{
 public:
  ...
  virtual std::string MakeString(int event_no, std::string name, const Option_t* opt) const; // Added by Kaare
...
class fiTQunInfo : public TObject
{
 public:
  ...
  // cut parameters
  void Get_fq_q(Double_t value) { fq_q = value; }
  void Get_fqe_dw(Double_t value) { fqe_dw = value; }
  void Get_fqe_dwd(Double_t value) { fqe_dwd = value; }
  void Get_fqmu_dw(Double_t value) { fqmu_dw = value; }
  void Get_fqmu_dwd(Double_t value) { fqmu_dwd = value; }
